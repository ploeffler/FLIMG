AC_DEFUN([AC_CHECK_FLTK], [
  ...
  *** contains fltk-config.
      ...
      FLIMG_FLTK_API_MAJOR=${FLTK_VERSION%%.*}

      FLIMG_FLTK_API_MINOR=${FLTK_VERSION#*.};
      FLIMG_FLTK_API_MINOR=${FLIMG_FLTK_API_MINOR%%.*}

      FLIMG_FLTK_API_PATCH=${FLTK_VERSION#*.};
      FLIMG_FLTK_API_PATCH=${FLIMG_FLTK_API_PATCH#*.};
  ...
  *** To build $PACKAGE you need a FLTK version that provides API 1.3.
  ...
  AC_DEFINE_UNQUOTED([FLIMG_FLTK_API_MAJOR], [$FLIMG_FLTK_API_MAJOR], [FLTK API major version])
  AC_DEFINE_UNQUOTED([FLIMG_FLTK_API_MINOR], [$FLIMG_FLTK_API_MINOR], [FLTK API minor version])
  AC_DEFINE_UNQUOTED([FLIMG_FLTK_API_PATCH], [$FLIMG_FLTK_API_PATCH], [FLTK API patch])
